      ...
      <div class="modal-body ">
        ...
        <input type="hidden" name="id_vidio" id="id_vidio" value="">
          ...
          <div class="form-group">
            <label for="format" class="col-md-4 control-label">Output Format :</label>
            <div class="col-md-7">
          ...
          <div class="form-group">
          <label for="frame_size" class="col-md-4">Resolution:</label>
            <div class="col-md-7">
              <select class="form-control" id="frame_size" name="frame_size" required>
          ...
          <div class="form-group">
            <label for="framerate" class="col-md-4">Frame Rate :</label>
            <div class="col-md-7">
      ...
      <div class="card">
        <div class="card-body"> 
            <div class="row">
              <div class="col-1"></div>
              <div class="col-10">
                <h5 class="card-title">How to Make a Button Open a New Activity - Android Studio Tutorial</h10><p></p><hr>
                <div class="mistvideo" id="video2">
                  <noscript>
                    <a href="http://<?php echo $HOST ?>:8181/video2.html" target="_blank">
                      Click here to play this video
                    </a>
                  </noscript>
                  <script>
                ...
                <hr>
                <button class="btn btn-primary" onclick="Download('Video2.mkv')">Convert & Download</button>  
              </div>
              <div class="col-1"></div>
            </div>
          </div>
      ...
      <div class="card">
        <div class="card-body"> 
            <div class="row">
              <div class="col-1"></div>
              <div class="col-10">
                <h5 class="card-title">How to Create Welcome Screen (Splash Screen) in Android Studio</h10><p></p><hr>
                ...
                <hr>
                <button class="btn btn-primary" onclick="Download('Video3.mkv')">Convert & Download</button>  
              </div>
              <div class="col-1"></div>
            </div>
          </div>
      ...
      <div class="card">
        <div class="card-body"> 
            <div class="row">
              <div class="col-1"></div>
              <div class="col-10">
                <h5 class="card-title">How To Learn Android App Development (2018)</h10><p></p><hr>
                ...
                <hr>
                <button class="btn btn-primary" onclick="Download('Video4.mkv')">Convert & Download</button>  
              </div>
              <div class="col-1"></div>
            </div>
          </div>
      ...
      <div class="card">
        <div class="card-body"> 
            <div class="row">
              <div class="col-1"></div>
              <div class="col-10">
                <h5 class="card-title">Introduction to Android development with NetBeans and Maven</h10><p></p><hr>
                <div class="mistvideo" id="video5">
                  <noscript>
                    <a href="http://<?php echo $HOST ?>:8181/video5.html" target="_blank">
                      Click here to play this video
                    </a>
                  </noscript>
                  <script>
                ...
                <hr>
                <button class="btn btn-primary" onclick="Download('Video5.mkv')">Convert & Download</button>  
              </div>
              <div class="col-1"></div>
            </div>
          </div>
...
<div class="modal fade" id="modal_download" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLongTitle">Siap Download</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <a href="http://dummylink" download><button class="btn btn-primary">Download</button></a>        
      </div>
    </div>
  </div>
</div>
